  ...
  return (
    <div className="min-h-screen bg-bg text-ink">
      ...
      <main className="mx-auto max-w-[980px] px-4 sm:px-6 lg:px-8 pb-24 pt-12">
        ...
        {/* Brand Content premium (pilier 2 du business model). */}
        <section className="mb-6 rounded-[16px] border border-[#D6282D] bg-[rgba(214,40,45,0.05)] px-7 py-8">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h2 className="font-serif text-[24px] font-semibold">Faites raconter votre entreprise</h2>
              <p className="mt-2 max-w-[54ch] text-[14px] text-ink-2">
                Interview de votre dirigeant, reportage dans vos murs, communiqué sponsorisé, sponsoring de notre
                newsletter : des contenus produits par la rédaction, que les lecteurs lisent jusqu&apos;au bout.
              </p>
            </div>
            <Link
              href="/publicite/brand-content"
              className="inline-block flex-none rounded-pill bg-red px-7 py-3 text-[14px] font-bold text-white"
            >
              Découvrir le Brand Content →
            </Link>
          </div>
        </section>
