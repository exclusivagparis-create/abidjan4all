...
/**
 * Éditeur de texte enrichi (contentEditable) pour un bloc « Texte enrichi ».
 * Stocke du HTML nettoyé côté serveur au save. Utilise document.execCommand
 * (déprécié mais universellement supporté et sans dépendance lourde) pour la
 * mise en forme inline. Tableau inséré via insertHTML.
 */
...
export function RichTextEditor({ value, onChange }: { value: string; onChange: (html: string) => void }) {
  ...
  return (
    <div className="rounded-md border border-line bg-surface">
      {/* barre d'outils */}
      <div className="flex flex-wrap items-center gap-0.5 border-b border-line-2 bg-surface-2 px-2 py-1.5">
