 ...
 */
export async function lireRubriques(reglages = REGLAGES, fetcher = fetch) {
...
export function fabriquerSlug(titre) {
 ...
 */
export function controlerArticles(reponse, dossiers, rubriques) {
  const griefs = [];
 ...
 */
export function enBlocsDuSite(article, dossier) {
  const note = [
